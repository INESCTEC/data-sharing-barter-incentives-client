...
class RequestController:
    ...
    def __init__(self):
        self.retries = int(os.environ.get('N_REQUEST_RETRIES', 3))
        self.remote_host = os.environ.get("VALOREM_REST_HOST", None)
        self.remote_port = os.environ.get("VALOREM_REST_PORT", None)
